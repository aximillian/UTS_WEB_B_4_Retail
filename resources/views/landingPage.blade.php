...
@section('content')
    ...
    <div class="container-index">
        <video autoplay muted loop id="video-bg" class="video-background">
            <source src="{{ asset('video/bg.mov') }}" type="video/mp4">
        </video>
        <div class="title-index">
            <img src="{{ asset('img/Kethebook.png') }}" alt="Logo">
            <a class="btn btn-outline btn-concert text-center" href="{{ url('login') }}">Continue</a>
        </div>
    </div>
@endsection
